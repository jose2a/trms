...
public class EventConfirmGradeServlet extends BaseServlet implements DoPostMethod {
	...
	public void post(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			eventService.confirmPassingGrade(confirmGradePres.getEventId(), confirmGradePres.isSuccessful());
